...
\begin{definition} Let \(p : E \rightarrow  B\) and \({p}^{\prime } : {E}^{\prime } \rightarrow  B\) be covering maps. They are said to be equivalent if there exists a homeomorphism \(h : E \rightarrow  {E}^{\prime }\) such that \(p = {p}^{\prime } \circ  h\) . The homeomorphism \(h\) is called an equivalence of covering maps or an equivalence of covering spaces
\end{definition}
...
\begin{definition} If \(H\) is a subgroup of the group \(G\) , then the normalizer of \(H\) in \(G\) is the subset of \(G\) defined by the equation
...
\begin{definition} If \(G\) is a group of homeomorphisms of \(X\) , the action of \(G\) on \(X\) is said to be properly discontinuous if for every \(x \in  X\) there is a neighborhood \(U\) of \(x\) such that \(g\left( U\right)\) is disjoint from \(U\) whenever \(g \neq  e\) . (Here \(e\) is the identity element of \(G\) .) It follows that \({g}_{0}\left( U\right)\) and \({g}_{1}\left( U\right)\) are disjoint whenever \({g}_{0} \neq  {g}_{1}\) , for otherwise \(U\) and \({g}_{0}^{-1}{g}_{1}\left( U\right)\) would not be disjoint.
\end{definition}
...
\begin{definition} A space \(B\) is said to be semilocally simply connected if for each \(b \in  B\) , there is a neighborhood \(U\) of \(b\) such that the homomorphism
