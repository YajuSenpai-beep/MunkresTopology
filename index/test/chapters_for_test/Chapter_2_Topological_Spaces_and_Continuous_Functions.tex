...
EX AMPLE 3. Let \(X\) be a set, let \({\mathcal{T}}_{f}\) be the collection of all subsets \(U\) of \(X\) such that \(X - U\) either is finite or is all of \(X\) Then \({\mathcal{T}}_{f}\) is a topology on \(X\) , called the finite complement topology. Both \(X\) and \(\varnothing\) are in \({\mathcal{T}}_{f}\) , since \(X - X\) is finite and \(X - \varnothing\) is all of \(X\) If \(\left\{  {U}_{\alpha }\right\}\) is an indexed family of nonempty elements of \({\mathcal{T}}_{f}\) , to show that \(\bigcup {U}_{\alpha }\) is in \({\mathcal{T}}_{f}\) , we compute
...
EXAMPLE 2. Let \({\mathcal{B}}^{\prime }\) be the collection of all rectangular regions (interiors of rectangles) in the plane, where the rectangles have sides parallel to the coordinate axes Then \({\mathcal{B}}^{\prime }\) satisfies both conditions for a basis. The second condition is illustrated in Figure 132; in thus case, the condition is trivial, because the intersection of any two basis elements is itself a basis element (or empty) As we shall see later, the basis \({\mathcal{B}}^{\prime }\) generates the same topology on the plane as the basis \(\mathcal{B}\) given in the preceding example
...
Definition. A subbasis \(S\) for a topology on \(X\) is a collection of subsets of \(X\) whose union equals \(X\) . The topology generated by the subbasis \(S\) is defined to be the collection \(\mathcal{T}\) of all unions of finite intersections of elements of \(\mathcal{S}\) .
...
EXAMPLE I Consider the subset \(Y = \left\lbrack  {0,1}\right\rbrack\) of the real line \(\mathbb{R}\) , in the subspace topology. The subspace topology has as basis all sets of the form \(\left( {a,b}\right)  \cap  Y\) , where(a, b)is an open interval in \(\mathbb{R}\) Such a set is of one of the following types.
...
EXAMPLE 3 In the finite complement topology on a set \(X\) , the closed sets consist of \(X\) itself and all finute subsets of \(X\)
...
EXAMPLE 7 Consider the subspace \(Y = (0,1\rbrack\) of the real line \(\mathbb{R}\) . The set \(A = \left( {0,\frac{1}{2}}\right)\) is a subset of \(Y\) , its closure in \(\mathbb{R}\) is the set \(\left\lbrack  {0,\frac{1}{2}}\right\rbrack\) , and its closure in \(Y\) is the set \(\left\lbrack  {0,\frac{1}{2}}\right\rbrack   \cap  Y =\)  \(\left( {0,\frac{1}{2}}\right\rbrack\)
...
EXAMPLE 4. The function \(f : \mathbb{R} \rightarrow  \mathbb{R}\) given by \(f\left( x\right)  = {3x} + 1\) is a homeomorphism See Figure 18 2. If we define \(g \cdot  \mathbb{R} \rightarrow  \mathbb{R}\) by the equation
...
Definition. Let \(J\) be an index set. Given a set \(X\) , we define a \(J\) -tuple of elements of \(X\) to be a function \(\mathbf{x} : J \rightarrow  X\) . If \(\alpha\) is an element of \(J\) , we often denote the value of \(x\) at \(\alpha\) by \({x}_{\alpha }\) rather than \(x\left( \alpha \right)\) ; we call it the \(\alpha\) th coordinate of \(x\) . And we often denote the function \(x\) itself by the symbol
...
Theorem 20.1. Let \(X\) be a metric space with metric \(d\) . Define \(\widetilde{d} : X \times  X \rightarrow  \mathbb{R}\) by the equation
...
Definition. Given an index set \(J\) , and given points \(\mathbf{x} = {\left( {x}_{\alpha }\right) }_{\alpha  \in  J}\) and \(\mathbf{y} = {\left( {y}_{\alpha }\right) }_{\alpha  \in  J}\) of \({\mathbb{R}}^{J}\) , let us define a metric \(\bar{\rho }\) on \({\mathbb{R}}^{J}\) by the equation
