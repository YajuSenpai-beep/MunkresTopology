...
EXAMPLE I Take the unit circle \({S}^{1}\) in \({\mathbb{R}}^{2}\) and let \(h.\left( {0,1}\right)  \rightarrow  {S}^{1}\) be the map
...
EXAMPLE 2 Let \(Y\) be the space \(\left\lbrack  {0,1}\right\rbrack\) Then \(Y\) is a compacufication of \(X\) , it is obtained by "adding one point at each end of(0,1)"
...
EXAMPLE 4 Let \(X = \left( {0,1}\right)\) Consider the one-point compactification of \(X\) given in Example I A bounded continuous function \(f : \left( {0,1}\right)  \rightarrow  \mathbb{R}\) is extendable to this compacutfication if and only if the limits
