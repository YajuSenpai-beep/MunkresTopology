...
\begin{theorem}[Nagata-Smirnov metrization theorem] A space \(X\) is metrizable if and only if \(X\) is regular and has a basis that is countably locally finite.
\end{theorem}
...
\begin{theorem}[Bing metrization theorem] A space \(X\) is metrizable if and only if it is regular and has a basis that is countably locally discrete.
\end{theorem}
...
The condition that \({\widetilde{V}}_{\alpha } \subset  {U}_{\alpha }\) for each \(\alpha\) is sometimes expressed by saying that the family \(\left\{  {\widetilde{V}}_{\alpha }\right\}\) is a precise refinement of the family \(\left\{  {U}_{\alpha }\right\}\) .
...
5. Let \(X\) be paracompact. We proved a "shnnking lemma" for arbitrary indexed open coverings of \(X\) . Here is an "expansion lemma" for arbitrary locally finite indexed families in \(X\) .
