...
\begin{centeredblock}
\begin{example}
	The product of two paracompact spaces need not be paracompact The space \({\mathbb{R}}_{\ell }\) is paracompact, for it is regular and Lindelof However, \({\mathbb{R}}_{\ell } \times {\mathbb{R}}_{\ell }\) is not paracompact, for it is Hausdorff but not normal
\end{example}
\end{centeredblock}
...
-Lemma 41.6. Let \(X\) be a paracompact Hausdorff space; let \({\{ {U}_{\alpha }\} }_{\alpha \in J}\) be an indexed family of open sets covering \(X\) . Then there exists a locally finite indexed family \({\{ {V}_{\alpha }\} }_{\alpha \in J}\) of open sets covering \(X\) such that \({\bar{V}}_{\alpha } \subset {U}_{\alpha }\) for each \(\alpha\) .
...
\item
 ...
 \end{enumerate}
\item Let \(X\) be paracompact. We proved a ``shrinking lemma'' for arbitrary indexed open coverings of \(X\) . Here is an ``expansion lemma'' for arbitrary locally finite indexed families in \(X\) . \textsl{Lemma} Let \({\{ {B}_{\alpha }\} }_{\alpha \in J}\) be a locally finite indexed family of subsets of the para-compact Hausdorff space \(X\) . Then there \(\iota\) s a locally finite indexed family \({\{ {U}_{\alpha }\} }_{\alpha \in J}\) of open sets in \(X\) such that \({B}_{\alpha } \subset {U}_{\alpha }\) for each \(\alpha\) . 
\item
 \begin{enumerate}[itemsep=0.2em, parsep=0pt, topsep=0pt, partopsep=0pt, leftmargin=*, label=(\alph*), align=left]
