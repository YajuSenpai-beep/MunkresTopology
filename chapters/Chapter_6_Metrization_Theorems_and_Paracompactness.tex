...
\begin{center}
	\munkrescomm{0.7043}{%
		\node[anchor=base west] (dg39) at (242.5,    0.0) {§39 Local finiteness};
		\node[anchor=base west] (dg40) at (  0.0,  -86.6) {§40};
		\node[anchor=base west] (dgng) at (311.8,  -86.6) {The Nagata-Smirnov metrization theorem};
		\node[anchor=base west] (dg41) at (242.5, -175.0) {§41 Paracompactness};
