...
\item[*7.] Let \(X\) be a regular space.
 ...
 \end{enumerate}
\item Let \(p : X \rightarrow Y\) be a perfect map. (See Exercise 7 of \S\ 31.)
 \begin{enumerate}[itemsep=0.2em, parsep=0pt, topsep=0pt, partopsep=0pt, leftmargin=*, label=(\alph*), align=left]
 ...
 \end{enumerate}
\item Let \(G\) be a locally compact, connected topological group. Show that \(G\) is paracompact. [Hint. Let \(U_{1}\) be a neighborhood of \(e\) having compact closure. In general, define \(U_{n + 1} = \bar{U}_{n} \cdot {U}_{1}\). Show the union of the sets \(\bar{U}_{n}\) is both open and closed in \(G\).] This result holds without assuming \(G\) is connected, but the proof requires more effort.
\item Theorem. If \(X\) is a Hausdorff space that is locally compact and paracompact, then each component of \(X\) has a countable basis. \textsl{Proof.} If \(X_{0}\) is a component of \(X\), then \(X_{0}\) is locally compact and paracompact. Let \(\mathcal{C}\) be a locally finite covering of \(X_{0}\) by sets open in \(X_{0}\) that have compact closures. Let \(U_{1}\) be a nonempty element of \(\mathcal{C}\), and in general let \(U_{n}\) be the union of all elements of \(\mathcal{C}\) that intersect \(\bar{U}_{n - 1}\). Show \(\bar{U}_{n}\) is compact, and the sets \(U_{n}\) cover \(X_{0}\). 
\end{enumerate}
