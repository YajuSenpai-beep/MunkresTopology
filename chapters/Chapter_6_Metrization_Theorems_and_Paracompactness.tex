...
\begin{lemma}
	Let \(\mathcal{A}\) be a \index{locally finite collection@Locally finite collection}locally finite collection of subsets of \(X\) . Then:
...
\end{proof}
\begin{definition}
	A collection \(\mathcal{B}\) of subsets of \(X\) is said to be \index{countably locally finite@Countably locally finite}countably locally finite if \(\mathcal{B}\) can be written as the countable union of collections \({\mathcal{B}}_{n}\) , each of which is locally finite.
\end{definition}
...
\item A collection \(\mathcal{A}\) of subsets of \(X\) is said to be \index{Locally discrete} if each point of \(X\) has a neighborhood that intersects at most one element of \(\mathcal{A}\) . A collection \(\mathcal{B}\) is \index{Countably locally discrete} (or `` \(\sigma\) -\index{locally discrete@Locally discrete}locally discrete'') if it equals a countable union of locally discrete collections. Prove the following: \textsl{Theorem. (\index{bing metrization theorem@Bing metrization theorem}).} A space \(X\) is metrizable if and only if it is regular and has a basis that is \index{countably locally discrete@Countably locally discrete}countably locally discrete. 
\end{enumerate}
\section*{§ 41 Paracompactness}

The concept \index{Normality!of paracompact Hausdorff space}of \index{Compact Hausdorff space: is Baire space!paracompactness}paracompactness is one of the most useful generalizations of compactness that has been discovered in recent years. It is particularly useful for applications in topology and differential geometry We shall give just one application, a metrization theorem that we prove in the next section.
...
A space \(X\) is compact if every open covering \(\mathcal{A}\) of \(X\) has a finite \index{open refinement@Open refinement}open refinement \(\mathcal{B}\) that covers \(X\)
...
\(( 3)  \Rightarrow  ( 4)\) . Let \(\mathcal{A}\) be an open covering of \(X\) . Using(3), choose \(\mathcal{B}\) to be a refinement of \(\mathcal{A}\) that covers \(X\) and is locally finite (We can take \(\mathcal{B}\) to be a \index{closed refinement@Closed refinement}closed refinement if we like, but that is irrelevant.) We seek to expand each element \(B\) of \(\mathcal{B}\) slightly to an open set, making the expansion slight enough that the resulting collection of open sets will still be locally finite and will still refine \(\mathcal{A}\) .
...
\item
  ...
  \item Show that the \index{Product topology!paracompactness}product of a paracompact space and a compact space is para-compact. [Hint: Use the tube lemma.]
...
\item
  \begin{enumerate}[itemsep=0.2em, parsep=0pt, topsep=0pt, partopsep=0pt, leftmargin=*, label=(\alph*), align=left]
  \item Show that for each \(x \in  {S}_{\Omega }\) , the section \index{\({S}_{\Omega }\)!metrizability}\index{Paracompactness!of \({S}_{\Omega }\)}of \({S}_{\Omega }\) by \(x\) has a countable basis and hence is metrizable.

  \item Conclude that \({S}_{\Omega }\) is \index{\({S}_{\Omega }\)!paracompactness}not paracompact.
  \end{enumerate}
\end{enumerate}