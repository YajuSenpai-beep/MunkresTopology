...
\begin{lemma}
	Let \(\mathcal{A}\) be a \index{Locally finite collection}\index{Locally finite collection}\index{locally finite collection@Locally finite collection}locally finite collection of subsets of \(X\) . Then:
...
\end{proof}
\begin{definition}
	A collection \(\mathcal{B}\) of subsets of \(X\) is said to be \index{Countably locally finite}\index{Countably locally finite}\index{countably locally finite@Countably locally finite}countably locally finite if \(\mathcal{B}\) can be written as the countable union of collections \({\mathcal{B}}_{n}\) , each of which is locally finite.
\end{definition}
...
\item A collection \(\mathcal{A}\) of subsets of \(X\) is said to be \index{locally discrete} if each point of \(X\) has a neighborhood that intersects at most one element of \(\mathcal{A}\) . A collection \(\mathcal{B}\) is \index{countably locally discrete} (or `` \(\sigma\) -\index{Locally discrete}\index{Locally discrete}\index{locally discrete@Locally discrete}locally discrete'') if it equals a countable union of locally discrete collections. Prove the following: \textsl{Theorem. (\index{Bing metrization theorem}).} A space \(X\) is metrizable if and only if it is regular and has a basis that is \index{Countably locally discrete}\index{Countably locally discrete}\index{countably locally discrete@Countably locally discrete}countably locally discrete. 
\end{enumerate}
...
A space \(X\) is compact if every open covering \(\mathcal{A}\) of \(X\) has a finite \index{Open refinement}\index{Open refinement}\index{open refinement@Open refinement}open refinement \(\mathcal{B}\) that covers \(X\)
...
\(( 3)  \Rightarrow  ( 4)\) . Let \(\mathcal{A}\) be an open covering of \(X\) . Using(3), choose \(\mathcal{B}\) to be a refinement of \(\mathcal{A}\) that covers \(X\) and is locally finite (We can take \(\mathcal{B}\) to be a \index{Closed refinement}\index{Closed refinement}\index{closed refinement@Closed refinement}closed refinement if we like, but that is irrelevant.) We seek to expand each element \(B\) of \(\mathcal{B}\) slightly to an open set, making the expansion slight enough that the resulting collection of open sets will still be locally finite and will still refine \(\mathcal{A}\) .
