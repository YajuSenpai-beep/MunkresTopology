\chapter[Metrization Theorems and Paracompactness]{Metrization Theorems \\and Paracompactness}
\vspace{6.5cm}
\chaptermark{Metrization Theorems and Paracompactness}
...
Some of the properties of a \index{paracompact space@Paracompact space}\index{paracompact space@Paracompact space}\index{paracompact space@Paracompact space}paracompact space are similar to those of a compact space. For instance, a subspace \index{Paracompactness!of closed subspace}of a paracompact space is not necessarily paracompact; but a closed subspace is paracompact. Also, a paracompact Hausdorff space is normal. In other ways, a paracompact space is not similar to a compact space; in particular, the product of two paracompact spaces need not be paracompact. We shall verify these facts shortly.
