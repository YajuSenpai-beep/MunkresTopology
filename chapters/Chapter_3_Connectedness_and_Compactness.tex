...
of nonempty closed sets of \(X\). Because \(X\) is compact, there is a point \(x \in \bigcap {\bar{V}}_{n}\), by \hyperref[thm:26.9]{Theorem 26.9}. Now \(x\) cannot equal \(x_{n}\) for any \(n\), since \(x\) belongs to \(V_{n}\) and \(x_{n}\) does not.
\end{proof}
