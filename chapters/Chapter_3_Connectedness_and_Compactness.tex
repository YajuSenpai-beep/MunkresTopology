...
The property of the space \(\left\lbrack  {a,b}\right\rbrack\) on which the intermediate value theorem depends is the property called \idx{connectedness}, and the property on which the other two depend is the property called \idx{compact}ness. In this chapter, we shall define these properties for arbitrary topological spaces, and shall prove the appropriate \idx{General linear group} generalized versions of these theorems.
