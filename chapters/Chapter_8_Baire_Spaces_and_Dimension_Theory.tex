...
\end{proof}
\begin{lemma}
Let \({C}_{1} \supset {C}_{2} \supset \cdots\) be a nested sequence of nonempty closed sets in the complete metric space \(X\). If \(\operatorname{diam}{C}_{n} \rightarrow 0\), then \(\cap {C}_{n} \neq \varnothing\).
\end{lemma}
