...
\begin{definition}
	Recall that if \(A\) is a subset of a space \(X\) , the interior of \(A\) is defined as the union of all open sets of \(X\) that are contained in \(A\) . To say that \(A\) has is to say then that \(A\) contains no open set of \(X\) other than the empty set. Equivalently, \(A\) has empty interior if every point of \(A\) is a limit point of the complement of \(A\) , that is, if the complement of \(A\) is dense in \(X\) .
\end{definition}
...
\end{proof}
egin{theorem}[Baire category theorem]
...
(1) \(\bigcap {U}_{n}\) consists of . Let \(f \in \bigcap {U}_{n}\) . We shall prove that given \(x\) in \([ {0,1}]\) , the limit
...
We shall define, for an arbitrary topological space \(X\) , a notion of topological dimension. It is the ``'' originally defined by Lebesgue We shall prove that each compact subset of \({\mathbb{R}}^{m}\) has topological dimension at most \(m\) . We shall also prove that the topological dimension of any compact \(m\) -manifold is at most \(m\) . (It is, in fact, precisely \(m\) , but this we shall not prove.)
...
\begin{definition}
	A space \(X\) is said to be if there is some integer \(m\) such that for every open covering \(\mathcal{A}\) of \(X\) , there is an open covering \(\mathcal{B}\) of \(X\) that refines \(\mathcal{A}\) and has order at most \(m + 1\) . The topological dimension of \(X\) is defined to be the smallest value of \(m\) for which this statement holds; we denote it by \(\dim X\) .
\end{definition}
...
\begin{definition}
	A set \(\{ {{\mathbf{x}}_{0},\ldots ,{\mathbf{x}}_{k}}\}\) of points of \({\mathbb{R}}^{N}\) is said to be , or , if the equations
