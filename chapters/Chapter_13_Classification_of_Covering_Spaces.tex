...
Up to this point, we have used \idx[classification]{Classification: of covering spaces} covering spaces primarily as a tool for computing fundamental groups. Now we turn things around and use the fundamental group as a tool for studying covering spaces.
...
Throughout the chapter, we assume the general \idx[general lifting lemma]{Lifting lemma: general} lifting correspondence theorem, Theorem 54.6.
