...
of subsets of \({X}_{1}\) also has the finite intersection property, and so does the collection of their closures \(\overline{{\pi }_{1}\left( A\right) }\) . Compactness of \({X}_{1}\) guarantees that the intersection of all the sets \(\overline{{\pi }_{1}\left( A\right) }\) is nonempty. Let us choose a point \({x}_{1}\) belongingg to this intersection. Similarly, let us choose a point \({x}_{2}\) belongingg to all the sets \(\overline{{\pi }_{2}\left( A\right) }\) . The obvious conclusion we would like to draw is that the point \({x}_{1} \times  {x}_{2}\) lies in \(\mathop{\bigcap }\limits_{{A \in  A}}A\) , for then our theorem would be proved.
