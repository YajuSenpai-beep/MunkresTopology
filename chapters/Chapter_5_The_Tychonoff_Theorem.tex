...
\item Let \(X\) be a space. Let \(\mathcal{D}\) be a collection of subsets of \(X\) that is maximal with respect to the finite intersection property
  ...
  \end{enumerate}
\item A collection \(\mathcal{A}\) of subsets of \(X\) has the \idx{countable intersection property} if every countable intersection of elements of \(\mathcal{A}\) is nonempty. Show that \(X\) is a Lindelöf space if and only if for every collection \(\mathcal{A}\) of subsets of \(X\) having the countable intersection property,
\end{enumerate}
...
\item (a) If \(X\) is normal and \(y\) is a point of \(\beta \left( X\right)  - X\) , show that \(y\) is not the limit of a sequence of points of \(X\) .
  \begin{enumerate}[itemsep=0.2em, parsep=0pt, topsep=0pt, partopsep=0pt, leftmargin=*, label=(\alph*), align=left]
