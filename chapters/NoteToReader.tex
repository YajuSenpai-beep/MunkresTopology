...
\chaptermark{A Note to the Reader}
\vspace{6.5cm}
...
\begin{description}\advance\leftskip 1em
  \item[\({\mathbb{R}}^{J}\)] the product of the real line with itself, in the product, uniform, and box topologies.
  \item[\({\mathbb{R}}_{\ell}\)] the real line in the topology having the intervals \([a,b)\) as a basis.
  \item[\({S}_{\Omega}\)] the minimal uncountable well-ordered set.
  \item[\({I}_{o}^{2}\)] the closed unit square in the dictionary order topology.
\end{description}
