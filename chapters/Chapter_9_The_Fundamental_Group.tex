...
\begin{definition}
	Let \(p : B \rightarrow B\) be continuous and surjective. If every point \(b\) of \(B\) has a neighborhood \(U\) that is evenly covered by \(p\) , then \(p\) is called a covering map, and \(E\) is said to be a covering space of \(B\)
\end{definition}
