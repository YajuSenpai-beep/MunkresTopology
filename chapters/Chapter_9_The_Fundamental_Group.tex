...
\begin{center}
	\munkrescomm{0.3062}{%
		\node (A) at (190, -118) {$\pi_1(X,x_0)$};
		\node (B) at (820, -115) {$\pi_1(Y,y_0)$};
...
\begin{center}
	\munkrescomm{0.1376}{%
		...
		\node (X) at ( 85, -829) {$X$};
		\node (B) at (838, -830) {$B$};
		\draw[->] (X) -- node[above left=-2pt,pos=.5] {$\bar{f}$} (E);
...
\begin{center}
	\munkrescomm{0.1439}{%
		\node (A) at (116, -204) {$S^1$};
		\node (B) at (910, -204) {$S^1$};
		\node (C) at (113, -959) {$S^1$};
		\node (D) at (879, -959) {$S^1$};
...
\begin{center}
	\munkrescomm{0.3048}{%
		...
		\draw[->] (A) -- node[below right=-2pt,pos=.5] {$k_*$} (C);
