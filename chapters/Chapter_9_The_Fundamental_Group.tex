\chapter[The \index{\({B}^{n}\)!fundamental group}Fundamental Group]{The Fundamental Group}
\vspace{6.5cm}
...
for each \(x\) . (Here \(I = [  {0,1}]\) .) The map \(F\) is called a \index{Homotopy}\index{Homotopy}\index{homotopy@Homotopy}homotopy between \(f\) and \({f}^{\prime }\) . If \(f\) is homotopic to \({f}^{\prime }\) , we write \(f \simeq  {f}^{\prime }\) . If \(f \simeq  {f}^{\prime }\) and \({f}^{\prime }\) is a constant map, we say that \(f\) is \index{Nulhomotopic map} nulhomotopic.
\end{definition}
...
for each \(s \in  I\) and each \(t \in  I\) . We call \(F\) a \index{Path homotopy}\index{Path homotopy}\index{path homotopy@Path homotopy}path homotopy between \(f\) and \({f}^{\prime }\) See Figure 51.1. If \(f\) is path homotopic to \({f}^{\prime }\) , we write \(f{ \simeq  }_{p}{f}^{\prime }\) .
\end{definition}
...
\item Let \(X\) be the quotient space obtained from \({B}^{2}\) by identifying each point \(x\) of \({S}^{1}\) with its \index{antipode@Antipode}antipode \(- x\) . Show that \(X\) is homeomorphic to the projective plane \({P}^{2}\) .
