...
\begin{center}
	\munkrescomm{0.3062}{%
		\node (A) at (190.0, -116.5) {$\pi_1(X,x_0)$};
		\node (B) at (820.0, -116.5) {$\pi_1(Y,y_0)$};
		\node (C) at (190, -500) {$\pi_1(X,x_1)$};
		\node (D) at (820, -500) {$\pi_1(Y,y_1)$};
		\draw[->] (A) -- node[above,pos=.5] {$(h_{x_0})_*$} (B);
		\draw[->] (A) -- node[left] {$\hat{\alpha}$} (C);
		\draw[->] (B) -- node[right] {$\hat{\beta}$} (D);
		\draw[->] (C) -- node[above,pos=.5] {$(h_{x_1})_*$} (D);
	}
	\label{fig:com_52_2}
\end{center}
\par\nopagebreak
...
\begin{center}
	\munkrescomm{0.1376}{%
		\node (E) at (838.5,  -95.0) {$E$};
		\node (X) at ( 85.0, -829.5) {$X$};
		\node (B) at (838.5, -829.5) {$B$};
		\draw[->] (X) -- node[above left=1pt,pos=.5] {$\bar{f}$} (E);
		\draw[->] (E) -- node[right] {$p$} (B);
		\draw[->] (X) -- node[below,pos=.5] {$f$} (B);
	}
	\label{fig:com_54_0}
\end{center}
\par\nopagebreak
...
\begin{center}
	\munkrescomm{0.1439}{%
		\node (A) at (114.5, -204.0) {$S^1$};
		\node (B) at (894.5, -204.0) {$S^1$};
		\node (C) at (114.5, -959.0) {$S^1$};
		\node (D) at (894.5, -959.0) {$S^1$};
		\draw[->] (B) -- node[above,pos=.5] {$h$} (A);
		\draw[->] (A) -- node[left] {$q$} (C);
		\draw[->] (B) -- node[right] {$q$} (D);
		\draw[->] (C) -- node[above,pos=.5] {$k$} (D);
	}
	\label{fig:com_57_0}
\end{center}
\par\nopagebreak 
...
\begin{center}
	\munkrescomm{0.3048}{%
		\node (A) at (187, -100) {$\pi_1(X,x_0)$};
		\node (B) at (750, -100) {$\pi_1(Y,y_0)$};
		\node (C) at (830, -450) {$\pi_1(Y,y_1)$};
		\draw[->] (A) -- node[above,pos=.5] {$h_*$} (B);
		\draw[->] (A) -- node[below right=1pt,pos=.5] {$k_*$} (C);
		\draw[->] (B) -- node[left] {$\hat{\alpha}$} (C);
	}
	\label{fig:com_58_25}
\end{center}
\par\nopagebreak 
...
\begin{center}
	\munkrescomm{0.3059}{%
		\node (A) at (190, -110) {$\pi_1(X,x_0)$};
		\node (B) at (865.0, -110.0) {$\pi_1(Y,y_0)$};
		\node (C) at (250, -470) {$\pi_1(X,x_1)$};
		\node (D) at (865.0, -470.0) {$\pi_1(Y,y_1)$};
		\draw[->] (A) -- node[above,pos=.5] {$(f_{x_0})_*$} (B);
		\draw[->] (C) -- node[above,pos=.5] {$(f_{x_1})_*$} (D);
		\draw[->] (B) -- node[below right=1pt,pos=.55] {$g_*$} (C);
	}
	\label{fig:com_58_35}
\end{center}
\par\nopagebreak 
