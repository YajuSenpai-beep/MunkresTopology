...
\begin{center}
	\munkrescomm{0.4755}{%
		\node (UV) at (140, -260) {$\pi_1(U \cap V, x_0)$};
		\node (U)  at (628.3,  -15.0) {$\pi_1(U, x_0)$};
		\node (X)  at (628.3, -260.0) {$\pi_1(X, x_0)$};
		\node (V)  at (628.3, -500.0) {$\pi_1(V, x_0)$};
		\node (H)  at (955, -260) {$H$};
		\draw[->] (UV) -- node[above left=1pt,pos=.45] {$i_1$} (U);
		\draw[->] (UV) -- node[below left=1pt,pos=.45] {$i_2$} (V);
		\draw[->] (UV) -- (X);
		\draw[->] (U) -- node[right] {$j_1$} (X);
		\draw[->] (V) -- node[right] {$j_2$} (X);
		\draw[->] (U) -- node[above right=1pt,pos=.45] {$\phi_1$} (H);
		\draw[->] (V) -- node[below right=1pt,pos=.45] {$\phi_2$} (H);
		\draw[->] (X) -- node[above,pos=.5] {$\Phi$} (H);
	}
	\label{fig:com_70_00}
\end{center}
\par\nopagebreak 
...
\begin{center}
	\munkrescomm{0.4758}{%
		...
		\draw[->] (UV) -- node[above left=1pt,pos=.45] {$i_1$} (U);
		\draw[->] (UV) -- node[below left=1pt,pos=.45] {$i_2$} (V);
		\draw[->] (UV) -- node[above,pos=.5] {$i_*$} (X);
		\draw[->] (U) -- node[right] {$j_1$} (X);
		\draw[->] (V) -- node[right] {$j_2$} (X);
		\draw[->] (U) -- node[above right=1pt,pos=.45] {$\phi_1$} (H);
		\draw[->] (V) -- node[below right=1pt,pos=.45] {$\phi_2$} (H);
		\draw[->] ([yshift=-6pt]X.east) -- node[below,pos=.45] {$\Phi$} ([yshift=-6pt]H.west);
		\draw[->] ([yshift=6pt]H.west) -- node[above,pos=.5] {$k$} ([yshift=6pt]X.east);
	}
	\label{fig:com_70_01}
\end{center}
\par\nopagebreak 
...
\begin{center}
	\munkrescomm{0.2883}{%
		\node (A) at (180,  -55) {$\pi_1(U,b)$};
		\node (B) at (830,  -55) {$\pi_1(X,b)$};
		\node (C) at (180, -440) {$\pi_1(U,a)$};
		\node (D) at (830, -440) {$\pi_1(X,a)$};
		\draw[->] (A) -- (B);
		\draw[->] (A) -- node[left] {$\hat{\alpha}$} (C);
		\draw[->] (B) -- node[right] {$\hat{\alpha}$} (D);
		\draw[->] (C) -- (D);
	}
	\label{fig:com_72_10}
\end{center}
