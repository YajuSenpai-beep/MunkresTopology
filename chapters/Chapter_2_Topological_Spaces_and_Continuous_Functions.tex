 ...
 \begin{example}
  ...
  \begin{center}
   \begin{tabular}{c@{\hspace{3em}}c}
    \includegraphics[width=0.38\linewidth]{images/13.1.png} &
    \includegraphics[width=0.30\linewidth]{images/13.2.png} \\[1em]
...
\begin{centeredblock}
 \begin{example}
  One can now see that the collection \(\mathcal{B}\) of all circular regions in the plane generates the same topology as the collection \({\mathcal{B}}^{\prime }\) of all rectangular regions, Figure 13.4 illustrates the proof. We shall treat this example more formally when we study metric spaces.
...
\begin{center}
\begin{tabular}{c@{\hspace{3em}}c}
  \includegraphics[width=0.45\linewidth]{images/17.1.png} &
  \includegraphics[width=0.45\linewidth]{images/17.2.png} \\[1em]
...
\begin{centeredblock}
\begin{example}
 The function \(f : \mathbb{R} \rightarrow \mathbb{R}\) given by \(f(x) = {3x} + 1\) is a homeomorphism. See Figure 18.2. If we define \(g : \mathbb{R} \rightarrow \mathbb{R}\) by the equation
...
\begin{example}
 ...
 \begin{center}
  \begin{tabular}{c@{\hspace{3em}}c}
   \includegraphics[width=0.40\linewidth]{images/18.2.png} &
   \includegraphics[width=0.42\linewidth]{images/18.3.png} \\[1em]
