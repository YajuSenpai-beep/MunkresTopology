...
\begin{center}
	\munkrescomm{0.1323}{%
		\node (X) at (164.5,  -91.0) {$X$};
		\node (Y) at (164.5, -856.0) {$Y$};
		\node (Z) at (836.0, -856.0) {$Z$};
		\draw[->] (X) -- node[above,pos=.5] {$g$} (Z);
		\draw[->] (X) -- node[left] {$p$} (Y);
		\draw[->] (Y) -- node[below,pos=.5] {$f$} (Z);
	}
	\label{fig:com_22_2}
\end{center}
\par\nopagebreak
...
\begin{center}
	\munkrescomm{0.1407}{%
		\node (X) at (168.0,  -89.0) {$X$};
		\node (S) at (168.0, -802.0) {$X^{*}$};
		\node (Z) at (930.0, -802.0) {$Z$};
		\draw[->] (X) -- node[above,pos=.5] {$g$} (Z);
		\draw[->] (X) -- node[left] {$p$} (S);
		\draw[->] (S) -- node[below,pos=.5] {$f$} (Z);
	}
	\label{fig:com_22_3}
\end{center}
\par\nopagebreak
