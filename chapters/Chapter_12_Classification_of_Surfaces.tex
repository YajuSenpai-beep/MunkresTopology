...
\begin{center}
	\munkrescomm{0.3895}{%
		\node (Be) at ( 62.3,  -64.6) {$\mathbf{B}_{\epsilon}-\mathbf{0}$};
		\node (B)  at (880.9,  -64.6) {$\mathbf{B}-\mathbf{0}$};
		\node (V)  at (533.1, -313.0) {$V-\mathbf{0}$};
...
\begin{center}
	\munkrescomm{0.4008}{%
		\node (Xe) at ( 61.4,  -59.5) {$\mathbf{X}_{\epsilon}-\mathbf{0}$};
		\node (X)  at (881.1,  -59.5) {$\mathbf{X}-\mathbf{0}$};
		\node (W)  at (530.8, -313.2) {$W-\mathbf{0}$};
