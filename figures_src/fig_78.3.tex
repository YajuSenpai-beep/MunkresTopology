...
\begin{tikzpicture}[x=1pt, y=-1pt, line width=6.0pt, line cap=round, line join=round]
  ...
  \draw[line width=6.0pt] (473.0,281.0) -- (480.0,277.0);
  ...
  \draw[line width=7.7pt] (386.0,285.0) -- (393.0,283.0);
  ...
  \draw[line width=9.9pt] (370.0,232.0) -- (367.0,223.0);
  ...
  \draw[line width=7.6pt] (363.0,238.0) -- (369.0,234.0);
  ...
  \draw[line width=7.6pt] (399.0,290.0) -- (395.0,284.0);
