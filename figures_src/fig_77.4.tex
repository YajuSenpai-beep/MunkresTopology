...
\begin{tikzpicture}[x=1pt, y=-1pt, line width=3.0pt, line cap=round, line join=round]
  ...
  % （略）线段 (759.0,126.0)-(749.0,121.0) 线宽7.0 —— 是箭头头那一坨，已由箭头头代替
  ...
  \draw[line width=7.5pt, -{Triangle[width=14.0pt,length=21.0pt]}] (453.5,342.5) -- (440.0,344.0);
  ...
  \draw[line width=7.0pt, -{Triangle[width=13.2pt,length=19.8pt]}] (49.5,343.5) -- (64.0,345.0);
  ...
  % （略）线段 (743.0,110.0)-(748.0,119.0) 线宽7.0 —— 是箭头头那一坨，已由箭头头代替
  ...
  \draw[line width=11.0pt, {Triangle[width=13.2pt,length=19.8pt]}-] (319.0,465.0) .. controls (327.0,467.7) and (341.3,467.7) .. (337.0,455.1);
  ...
  \fill (751.9,121.7) -- (746.1,116.3) -- (757.2,110.2) -- cycle;
  ...
  % （略）(48.0,343.0) r=8.1 落在箭头头上 —— 已由箭头头代替
  % （略）(455.0,343.5) r=7.2 落在箭头头上 —— 已由箭头头代替
  % （略）(68.5,346.0) r=4.7 落在箭头头上 —— 已由箭头头代替
  \fill (841.5,466.0) circle (3.6);
  \fill (1087.5,471.0) circle (6.9);
  % （略）(338.0,469.5) r=4.7 落在箭头头上 —— 已由箭头头代替
