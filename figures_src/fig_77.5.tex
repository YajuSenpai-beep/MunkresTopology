...
\begin{tikzpicture}[x=1pt, y=-1pt, line width=6.3pt, line cap=round, line join=round]
  ...
  \fill (646.9,156.0) -- (649.1,162.0) -- (639.0,162.2) -- cycle;
  ...
  % （略）线段 (651.0,161.0)-(656.0,157.0) 线宽7.0 —— 是箭头头那一坨，已由箭头头代替
  ...
  \fill (568.8,70.0) -- (569.2,60.0) -- (584.0,65.7) -- cycle;
  ...
  % （略）(569.5,60.5) r=4.5 落在箭头头上 —— 已由箭头头代替
