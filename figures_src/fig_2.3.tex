...
\begin{tikzpicture}[x=1pt, y=-1pt]
  ...
  % ── 三个空心圆点（中线半径 7、描边 4）──
  \draw[line width=4.0pt,fill=white] (\ox-\U,\oy-5*\U) circle (7);
  \draw[line width=4.0pt,fill=white] (\ox+\U,\oy-5*\U) circle (7);
  \draw[line width=4.0pt,fill=white] (\ox,\oy-2*\U)   circle (7);
  ...
  \node[anchor=center,inner sep=1.5pt,fill=white,font=\fontsize{28}{35}\selectfont] at (335.5,565.0) {\textsf{\textbf{2}}};
